...
export const redirectTinyUrl = async (req: Request, res: Response) => {
  ...
  try {
    ...
    // Get the original URL from the database response
    // const originalUrl = response.rows[0].url;
    // For demonstration purposes, we will not redirect but return the original URL
    // In a real application, you would redirect to the original URL
    // const originalUrl = "https://example.com"; // Replace with actual URL from database
    // For demonstration purposes, we will not redirect but return the original URL
    // In a real application, you would redirect to the original URL
    const originalUrl = response.rows[0].url;
...
export const createTinyUrl = async (req: Request, res: Response) => {
  try {
    ...
    // Here you would typically save the original URL to the database and generate a short URL
